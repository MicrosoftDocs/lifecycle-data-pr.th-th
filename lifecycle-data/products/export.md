...
---
# <a name="lifecycle-data-export"></a>การส่งออกข้อมูลวงจรการใช้งาน

## <a name="export-all-products"></a>ส่งออกผลิตภัณฑ์ทั้งหมด
ส่งออกข้อมูลวงจรการใช้งานสำหรับผลิตภัณฑ์ทั้งหมดโดยคลิกด้านล่าง:

> [!div class="nextstepaction"]
> [ส่งออกผลิตภัณฑ์ทั้งหมด](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a>ส่งออกผลิตภัณฑ์ตาม ตระกูล และ กลุ่ม
เลือก ตระกูล จากนั้นเลือก กลุ่ม ที่จะส่งออก หมายเหตุ: การส่งออกจะเริ่มต้นเมื่อเลือกค่า กลุ่ม 
...
## <a name="export-products-by-end-of-support-date"></a>ส่งออกผลิตภัณฑ์ภายในวันที่สิ้นสุดการสนับสนุน
เลือกปีเพื่อดูผลิตภัณฑ์ที่ถึงจุดสิ้นสุดการสนับสนุน หมายเหตุ: การส่งออกจะเริ่มต้นเมื่อเลือกค่าปี
